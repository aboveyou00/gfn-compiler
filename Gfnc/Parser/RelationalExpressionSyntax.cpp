...
{
    ExpressionSyntax *RelationalExpressionSyntax::tryParse(Cursor<Tokenizer::Token*> &cursor)
    {
    ...
    RelationalExpressionSyntax *RelationalExpressionSyntax::tryParseRhs(Cursor<Tokenizer::Token*> &cursor, ExpressionSyntax *lhs)
    {
