...
{
    ExpressionSyntax *EqualityExpressionSyntax::tryParse(Cursor<Tokenizer::Token*> &cursor)
    {
    ...
    EqualityExpressionSyntax *EqualityExpressionSyntax::tryParseRhs(Cursor<Tokenizer::Token*> &cursor, ExpressionSyntax *lhs)
    {
