...
{
    ExpressionSyntax *PrimaryExpressionSyntax::tryParse(Cursor<Tokenizer::Token*> &cursor)
    {
    ...
    bool PrimaryExpressionSyntax::tryResolveType()
    {
        ...
        case PrimaryExpressionType::StringLiteral:
            this->m_resolvedType = Runtime::RuntimeType::string();
            return true;
    ...
    void PrimaryExpressionSyntax::emit(Emit::MethodBuilder &mb) const
    {
        ...
        case PrimaryExpressionType::IntegerLiteral:
        {
            ...
            mb.addOpcode(new Emit::OpLdcI4((int32_t)val));
        }
        break;
        ...
        case PrimaryExpressionType::BooleanLiteral:
        {
            ...
            mb.addOpcode(new Emit::OpLdcI4(val ? 1 : 0));
        }
        break;
