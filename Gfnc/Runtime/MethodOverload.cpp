...
namespace Gfn::Compiler::Runtime
{
    ...
    MethodOverload::MethodOverload(RuntimeType *returnType, std::vector<RuntimeType*> argTypes, std::function<void(Emit::MethodBuilder &mb)> emitInvoke)
    ...
    void MethodOverload::emitInvoke(Emit::MethodBuilder &mb) const
    {
